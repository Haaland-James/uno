...
/**
 * WhatsApp brand glyph. lucide-react omits brand marks for trademark reasons,
 * so we ship the official outline ourselves. Single-path SVG, currentColor for
 * easy recoloring (defaults to white on our green pill backgrounds).
 */
