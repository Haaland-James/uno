...
function AgentVerifyForm() {
	...
	async function handleSubmit(e: React.FormEvent) {
		...
		// Hard navigate so the (agent) layout runs server-side and applies the
		// agentStatus gate. Non-agents are bounced back with ?error=not_agent.
